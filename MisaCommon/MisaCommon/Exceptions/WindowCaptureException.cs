namespace MisaCommon.Exceptions
{
    ...
    /// <summary>
    /// ウィンドウキャプチャの処理に関する例外を扱う <see cref="Exception"/> の派生クラス
    /// </summary>
    [Serializable]
    public class WindowCaptureException : Exception, ISerializable
    {
        #region コンストラクタ
        ...
        /// </exception>
        protected WindowCaptureException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
